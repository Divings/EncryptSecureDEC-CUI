...
def main():
    ...
    # For decrypt mode, check if file has valid .vdec extension
    if args.mode == "decrypt" and not (args.file.endswith(".vdec")):
        print(f"❌ Error: The file for decryption must have a '.vdec' extension.")
        sys.exit(1)
